...
To create an object of a class, you use the new keyword followed by the name of the class and the arguments for the constructor.
...
class Box(val length : Int, val width : Int, val bearth : Int) {
