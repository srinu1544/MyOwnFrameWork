...
----------------------------------
Set this flag on your Activity in AndroidManifest.xml to prevent your Activities
from being recreated. This ensures that all your views and data remain after an
orientation change.
...
--------------------------------
You can also save and restore fragment state, retain fragments, and properly
handle list state.
